...
export const ParserRules = [
    { "name": "rrule$string$1", "symbols": [{ "literal": "R" }, { "literal": "R" }, { "literal": "U" }, { "literal": "L" }, { "literal": "E" }], "postprocess": joiner },
    { "name": "rrule$ebnf$1", "symbols": ["CRLF"], "postprocess": id },
    { "name": "rrule$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "rrulparam$ebnf$1", "symbols": ["rrulparam$ebnf$1$subexpression$1", "rrulparam$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "ianaParam$ebnf$1", "symbols": ["ianaParam$ebnf$1$subexpression$1", "ianaParam$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "ianaToken$ebnf$1", "symbols": ["ianaToken$ebnf$1$subexpression$2", "ianaToken$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "paramtext$ebnf$1", "symbols": ["SAFECHAR", "paramtext$ebnf$1"], "postprocess": arrconcat },
    { "name": "paramtext", "symbols": ["paramtext$ebnf$1"] },
    { "name": "quotedString$ebnf$1", "symbols": [] },
    { "name": "quotedString$ebnf$1", "symbols": ["QSAFECHAR", "quotedString$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "xParam$ebnf$1", "symbols": ["xParam$ebnf$1$subexpression$1", "xParam$ebnf$1"], "postprocess": arrconcat },
    { "name": "xParam", "symbols": ["xName", { "literal": "=" }, "paramValue", "xParam$ebnf$1"] },
    { "name": "xName$string$1", "symbols": [{ "literal": "X" }, { "literal": "-" }], "postprocess": joiner },
    ...
    { "name": "xName$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "xName$ebnf$2", "symbols": ["xName$ebnf$2$subexpression$2", "xName$ebnf$2"], "postprocess": arrconcat },
    ...
    { "name": "vendorid$ebnf$1", "symbols": ["vendorid$ebnf$1$subexpression$2", "vendorid$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "recur$ebnf$1", "symbols": ["recur$ebnf$1$subexpression$1", "recur$ebnf$1"], "postprocess": arrconcat },
    { "name": "recur", "symbols": ["recurRulePart", "recur$ebnf$1"], "postprocess": (data: any[]) => [data[0]].concat(data[1].map((d: any) => d[1])) },
    { "name": "recurRulePart$string$1", "symbols": [{ "literal": "F" }, { "literal": "R" }, { "literal": "E" }, { "literal": "Q" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$1", { "literal": "=" }, "freq"], "postprocess": (data: any[]) => ["frequency", data[2][0].toLowerCase()] },
    { "name": "recurRulePart$string$2", "symbols": [{ "literal": "U" }, { "literal": "N" }, { "literal": "T" }, { "literal": "I" }, { "literal": "L" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$2", { "literal": "=" }, "enddate"], "postprocess": (data: any[]) => ["until", data[2][0]] },
    { "name": "recurRulePart$string$3", "symbols": [{ "literal": "C" }, { "literal": "O" }, { "literal": "U" }, { "literal": "N" }, { "literal": "T" }], "postprocess": joiner },
    { "name": "recurRulePart$ebnf$1", "symbols": ["DIGIT"] },
    { "name": "recurRulePart$ebnf$1", "symbols": ["DIGIT", "recurRulePart$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "recurRulePart$string$4", "symbols": [{ "literal": "I" }, { "literal": "N" }, { "literal": "T" }, { "literal": "E" }, { "literal": "R" }, { "literal": "V" }, { "literal": "A" }, { "literal": "L" }], "postprocess": joiner },
    { "name": "recurRulePart$ebnf$2", "symbols": ["DIGIT"] },
    { "name": "recurRulePart$ebnf$2", "symbols": ["DIGIT", "recurRulePart$ebnf$2"], "postprocess": arrconcat },
    ...
    { "name": "recurRulePart$string$5", "symbols": [{ "literal": "B" }, { "literal": "Y" }, { "literal": "S" }, { "literal": "E" }, { "literal": "C" }, { "literal": "O" }, { "literal": "N" }, { "literal": "D" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$5", { "literal": "=" }, "byseclist"], "postprocess": (data: any[]) => ["bySecond", data[2]] },
    { "name": "recurRulePart$string$6", "symbols": [{ "literal": "B" }, { "literal": "Y" }, { "literal": "M" }, { "literal": "I" }, { "literal": "N" }, { "literal": "U" }, { "literal": "T" }, { "literal": "E" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$6", { "literal": "=" }, "byminlist"], "postprocess": (data: any[]) => ["byMinute", data[2]] },
    { "name": "recurRulePart$string$7", "symbols": [{ "literal": "B" }, { "literal": "Y" }, { "literal": "H" }, { "literal": "O" }, { "literal": "U" }, { "literal": "R" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$7", { "literal": "=" }, "byhrlist"], "postprocess": (data: any[]) => ["byHour", data[2]] },
    { "name": "recurRulePart$string$8", "symbols": [{ "literal": "B" }, { "literal": "Y" }, { "literal": "D" }, { "literal": "A" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$8", { "literal": "=" }, "bywdaylist"], "postprocess": (data: any[]) => ["byDay", data[2]] },
    { "name": "recurRulePart$string$9", "symbols": [{ "literal": "B" }, { "literal": "Y" }, { "literal": "M" }, { "literal": "O" }, { "literal": "N" }, { "literal": "T" }, { "literal": "H" }, { "literal": "D" }, { "literal": "A" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$9", { "literal": "=" }, "bymodaylist"], "postprocess": (data: any[]) => ["byMonthDay", data[2]] },
    { "name": "recurRulePart$string$10", "symbols": [{ "literal": "B" }, { "literal": "Y" }, { "literal": "Y" }, { "literal": "E" }, { "literal": "A" }, { "literal": "R" }, { "literal": "D" }, { "literal": "A" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$10", { "literal": "=" }, "byyrdaylist"], "postprocess": (data: any[]) => ["byYearDay", data[2]] },
    { "name": "recurRulePart$string$11", "symbols": [{ "literal": "B" }, { "literal": "Y" }, { "literal": "W" }, { "literal": "E" }, { "literal": "E" }, { "literal": "K" }, { "literal": "N" }, { "literal": "O" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$11", { "literal": "=" }, "bywknolist"], "postprocess": (data: any[]) => ["byWeekNumber", data[2]] },
    { "name": "recurRulePart$string$12", "symbols": [{ "literal": "B" }, { "literal": "Y" }, { "literal": "M" }, { "literal": "O" }, { "literal": "N" }, { "literal": "T" }, { "literal": "H" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$12", { "literal": "=" }, "bymolist"], "postprocess": (data: any[]) => ["byMonth", data[2]] },
    { "name": "recurRulePart$string$13", "symbols": [{ "literal": "B" }, { "literal": "Y" }, { "literal": "S" }, { "literal": "E" }, { "literal": "T" }, { "literal": "P" }, { "literal": "O" }, { "literal": "S" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$13", { "literal": "=" }, "bysplist"], "postprocess": (data: any[]) => ["bySetPosition", data[2]] },
    { "name": "recurRulePart$string$14", "symbols": [{ "literal": "W" }, { "literal": "K" }, { "literal": "S" }, { "literal": "T" }], "postprocess": joiner },
    { "name": "recurRulePart", "symbols": ["recurRulePart$string$14", { "literal": "=" }, "weekday"], "postprocess": (data: any[]) => ["weekStart", data[2]] },
    { "name": "freq$string$1", "symbols": [{ "literal": "S" }, { "literal": "E" }, { "literal": "C" }, { "literal": "O" }, { "literal": "N" }, { "literal": "D" }, { "literal": "L" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "freq", "symbols": ["freq$string$1"] },
    { "name": "freq$string$2", "symbols": [{ "literal": "M" }, { "literal": "I" }, { "literal": "N" }, { "literal": "U" }, { "literal": "T" }, { "literal": "E" }, { "literal": "L" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "freq", "symbols": ["freq$string$2"] },
    { "name": "freq$string$3", "symbols": [{ "literal": "H" }, { "literal": "O" }, { "literal": "U" }, { "literal": "R" }, { "literal": "L" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "freq", "symbols": ["freq$string$3"] },
    { "name": "freq$string$4", "symbols": [{ "literal": "D" }, { "literal": "A" }, { "literal": "I" }, { "literal": "L" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "freq", "symbols": ["freq$string$4"] },
    { "name": "freq$string$5", "symbols": [{ "literal": "W" }, { "literal": "E" }, { "literal": "E" }, { "literal": "K" }, { "literal": "L" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "freq", "symbols": ["freq$string$5"] },
    { "name": "freq$string$6", "symbols": [{ "literal": "M" }, { "literal": "O" }, { "literal": "N" }, { "literal": "T" }, { "literal": "H" }, { "literal": "L" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "freq", "symbols": ["freq$string$6"] },
    { "name": "freq$string$7", "symbols": [{ "literal": "Y" }, { "literal": "E" }, { "literal": "A" }, { "literal": "R" }, { "literal": "L" }, { "literal": "Y" }], "postprocess": joiner },
    { "name": "freq", "symbols": ["freq$string$7"] },
    { "name": "enddate", "symbols": ["date"] },
    { "name": "enddate", "symbols": ["dateTime"] },
    { "name": "date", "symbols": ["dateValue"], "postprocess": (d: any) => {
            return new Date(d[0][0], d[0][1], d[0][2]);
        }
    },
    ...
    { "name": "time$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "byseclist$ebnf$1", "symbols": ["byseclist$ebnf$1$subexpression$1", "byseclist$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "seconds$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "byminlist$ebnf$1", "symbols": ["byminlist$ebnf$1$subexpression$1", "byminlist$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "minutes$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "byhrlist$ebnf$1", "symbols": ["byhrlist$ebnf$1$subexpression$1", "byhrlist$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "hour$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "bywdaylist$ebnf$1", "symbols": ["bywdaylist$ebnf$1$subexpression$1", "bywdaylist$ebnf$1"], "postprocess": arrconcat },
    { "name": "bywdaylist", "symbols": ["weekdaynum", "bywdaylist$ebnf$1"], "postprocess": (data: any[]) => {
        // console.log(data);
        return [data[0]].concat(data[1].map((d: any) => d[1]));
     } },
    ...
    { "name": "weekdaynum$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "weekdaynum$ebnf$1", "symbols": [], "postprocess": noresult },
    {
    ...
    { "name": "ordwk$ebnf$1", "symbols": [], "postprocess": noresult },
    { "name": "ordwk", "symbols": ["DIGIT", "ordwk$ebnf$1"], "postprocess": integer },
    { "name": "weekday$string$1", "symbols": [{ "literal": "S" }, { "literal": "U" }], "postprocess": joiner },
    { "name": "weekday", "symbols": ["weekday$string$1"], "postprocess": () => 0 },
    { "name": "weekday$string$2", "symbols": [{ "literal": "M" }, { "literal": "O" }], "postprocess": joiner },
    { "name": "weekday", "symbols": ["weekday$string$2"], "postprocess": () => 1 },
    { "name": "weekday$string$3", "symbols": [{ "literal": "T" }, { "literal": "U" }], "postprocess": joiner },
    { "name": "weekday", "symbols": ["weekday$string$3"], "postprocess": () => 2 },
    { "name": "weekday$string$4", "symbols": [{ "literal": "W" }, { "literal": "E" }], "postprocess": joiner },
    { "name": "weekday", "symbols": ["weekday$string$4"], "postprocess": () => 3 },
    { "name": "weekday$string$5", "symbols": [{ "literal": "T" }, { "literal": "H" }], "postprocess": joiner },
    { "name": "weekday", "symbols": ["weekday$string$5"], "postprocess": () => 4 },
    { "name": "weekday$string$6", "symbols": [{ "literal": "F" }, { "literal": "R" }], "postprocess": joiner },
    { "name": "weekday", "symbols": ["weekday$string$6"], "postprocess": () => 5 },
    { "name": "weekday$string$7", "symbols": [{ "literal": "S" }, { "literal": "A" }], "postprocess": joiner },
    ...
    { "name": "bymodaylist$ebnf$1", "symbols": ["bymodaylist$ebnf$1$subexpression$1", "bymodaylist$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "monthdaynum$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "ordmoday$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "byyrdaylist$ebnf$1", "symbols": ["byyrdaylist$ebnf$1$subexpression$1", "byyrdaylist$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "yeardaynum$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "ordyrday$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "ordyrday$ebnf$1", "symbols": [], "postprocess": noresult },
    { "name": "ordyrday", "symbols": ["DIGIT", "ordyrday$ebnf$1"], "postprocess": integer },
    { "name": "bywknolist$ebnf$1", "symbols": [] },
    { "name": "bywknolist$ebnf$1$subexpression$1", "symbols": [{ "literal": "," }, "weeknum"] },
    { "name": "bywknolist$ebnf$1", "symbols": ["bywknolist$ebnf$1$subexpression$1", "bywknolist$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "weeknum$ebnf$1", "symbols": [], "postprocess": noresult },
    { "name": "weeknum", "symbols": ["weeknum$ebnf$1", "ordwk"], "postprocess": integer },
    { "name": "bymolist$ebnf$1", "symbols": [] },
    { "name": "bymolist$ebnf$1$subexpression$1", "symbols": [{ "literal": "," }, "monthnum"] },
    { "name": "bymolist$ebnf$1", "symbols": ["bymolist$ebnf$1$subexpression$1", "bymolist$ebnf$1"], "postprocess": arrconcat },
    ...
    { "name": "monthnum$ebnf$1", "symbols": [], "postprocess": noresult },
    ...
    { "name": "bysplist$ebnf$1", "symbols": ["bysplist$ebnf$1$subexpression$1", "bysplist$ebnf$1"], "postprocess": arrconcat },
